...
namespace Fanwei\GoogleAuthenticator;
...
class GoogleAuthenticator
{
     ...
     * @return string
     */
    public function getQrcodeString($secret, $title)
    {
        $qrcodeString = 'otpauth://totp/%s?secret=%s';
        return vsprintf($qrcodeString, array($title, $secret));
    }
